...
$data = array(array(
    'KaspiOrderID' => $_REQUEST['KaspiOrderID'],
    'dealID'       => $_REQUEST['dealID'],
...
$fp = fopen('../../ftp/To1C/return_deal_'.$dealID.'.csv', 'w');
...
file_put_contents('logs/return_kaspi_kazakhstan.log', date("d/m/y - H:i -", time()).' '.'return_deal_'.$dealID."\n", FILE_APPEND);
