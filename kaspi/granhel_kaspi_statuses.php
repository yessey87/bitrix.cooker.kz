...
$url = 'https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=20&filter[orders][state]=SIGN_REQUIRED&filter[orders][creationDate][$ge]=' . $lasttimestamp . '&filter[orders][creationDate][$le]=' . $currenttimestamp . '';
...
$url = 'https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=20&filter[orders][state]=PICKUP&filter[orders][creationDate][$ge]=' . $lasttimestamp . '&filter[orders][creationDate][$le]=' . $currenttimestamp . '';
...
$url = 'https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=20&filter[orders][state]=DELIVERY&filter[orders][creationDate][$ge]=' . $lasttimestamp . '&filter[orders][creationDate][$le]=' . $currenttimestamp . '';
...
$url = 'https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=100&filter[orders][state]=KASPI_DELIVERY&filter[orders][status]=ACCEPTED_BY_MERCHANT&filter[orders][creationDate][$ge]=' . $lasttimestamp . '&filter[orders][creationDate][$le]=' . $currenttimestamp . '';
...
foreach($arr as $key => $value) {
    ...
    if ($KaspiStatus == 'CANCELLED' and $isKaspiDelivery) {
        $STAGEID = 'C3:FINAL_INVOICE';
    }elseif ($KaspiStatus == 'CANCELLED' and $isKaspiDelivery == false) {
        $STAGEID = 'C2:1';
    }  
